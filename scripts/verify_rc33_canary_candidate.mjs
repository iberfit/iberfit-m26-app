...
const EXPECTED_VERSION = '26.0.0-canary.33';
const EXPECTED_RELEASE = 'IBERFIT_M26_CANARY_RC33';
const EXPECTED_BRANCH = 'canary/rc33';
const EXPECTED_PROJECT_REF = 'pjhmrhejsoofmouedavw';
const EXPECTED_URL = `https://${EXPECTED_PROJECT_REF}.supabase.co`;
const EXPECTED_SW_VERSION = 'm26-rc33-canary-v1';
const EXPECTED_PREVIOUS_SW_VERSION = 'm26-rc32-canary-v1';
...
for (const [actual, expected, reason] of [
  ...
  [version.sourceRelease, 'RC33', 'source-release'],
...
fs.writeFileSync(
  path.join(root, 'recovery', 'RC33_BUILD_VERIFICATION.json'),

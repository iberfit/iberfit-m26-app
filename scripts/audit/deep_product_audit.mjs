...
async function get(url,label){
  ...
  try{return {response:await fetch(url,{method:'GET',redirect:'follow',cache:'no-store',headers:{'user-agent':'IBERFIT-M26-Deep-Auditor/2.1'},signal:controller.signal})};}

...
const checks = [
  ...
  ['Metadata y cache RC38 exactos', /26\.0\.0-canary\.38-iri-diagnosis-bioimpedance/u.test(generator) && /IBERFIT_M26_CANARY_RC38_IRI_DIAGNOSIS_BIOIMPEDANCE/u.test(generator) && /m26-rc38-iri-diagnosis-bioimpedance-canary-v3/u.test(generator) && /m26-rc37-iri-external-report-canary-v2/u.test(generator)],

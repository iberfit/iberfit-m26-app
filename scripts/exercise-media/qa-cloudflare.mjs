...
export function exerciseSpecificQaContract(exercise={}){
  ...
  return[
    ...
    'END must show exactly ONE support foot on the floor and the opposite moving leg ABDUCTED LATERALLY in the frontal plane. The moving shoe must be visibly off the floor with a clear gap beneath it.',
    ...
    'biomechanics is fail if both end-phase shoes touch the floor, if the moving leg travels mainly forward/backward, if the knee is prominently flexed/high, or if the hands assist the leg.',

...
export function supportObservationInstruction(exercise){
  if(!isQuadrupedalLocomotion(exercise))return'';
  return 'For this quadrupedal locomotion exercise, report support_observation exactly as {"palms_on_floor":0|1|2,"forefeet_on_floor":0|1|2,"knees_weight_bearing":boolean,"hip_height_relation":"below_shoulders|near_shoulders|above_shoulders|unclear","torso_relation":"approximately_parallel|upright|unclear","lunge_or_squat":boolean}. Count only clearly visible/defensible contacts; use unclear rather than guessing.';
}

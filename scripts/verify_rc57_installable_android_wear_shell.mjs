...
pass(
  "phone-module",
  settings.includes('include(":phone-app")')
);

pass(
  "wear-module",
  settings.includes('include(":wear-app")')
);
...
pass(
  "phone-sdk",
  phoneBuild.includes("minSdk = 26") &&
    phoneBuild.includes("targetSdk = 36")
);

pass(
  "wear-sdk",
  wearBuild.includes("minSdk = 30") &&
    wearBuild.includes("targetSdk = 36")
);

pass(
  "phone-kotlin-source-routing",
  phoneBuild.includes("kotlin.directories.addAll") &&
    !phoneBuild.includes("java.srcDirs")
);

pass(
  "wear-kotlin-source-routing",
  wearBuild.includes("kotlin.directories.addAll") &&
    !wearBuild.includes("java.srcDirs")
);

pass(
  "phone-canonical-runtime",
  phoneBuild.includes('"../../android/runtime"') &&
    phoneBuild.includes('"../../android/ble"')
);

pass(
  "wear-canonical-runtime",
...
pass(
  "wear-heart-rate-permission",
  wearManifest.includes(
...
pass(
  "phone-datalayer-shell",
  phoneActivity.includes(
...
pass(
  "wear-datalayer-shell",
  workoutService.includes(
    "IBERFITWearDataLayerRuntime"
  ) &&
...
pass(
  "wear-activity-ui-shell",
  wearActivity.includes(

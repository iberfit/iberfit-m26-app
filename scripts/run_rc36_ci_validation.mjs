...
const report={release:'IBERFIT_M26_CANARY_RC36_CI',version:'26.0.0-canary.36-premium-product-ci',generatedAt:new Date().toISOString(),sourceRevision,sourceBranch:'canary/rc36',sourceCommit:sourceRevision,baseBranch:'canary/rc35',baseCommit:'13e2c42d368998e71953f47317b1f61364f8f85e',backendContract:'RC30',ok:!stopped&&steps.every((step)=>step.ok)&&tests.total>0&&tests.failed===0,tests,steps,deliveredScope:['Informe IRI sin puntuaciones visuales no normativas',

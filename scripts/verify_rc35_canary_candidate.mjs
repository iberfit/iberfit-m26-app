...
const EXPECTED_VERSION = EXPECTED_RC38
  ...
  : EXPECTED_RC36
    ? '26.0.0-canary.36'
    : '26.0.0-canary.35';
const EXPECTED_RELEASE = EXPECTED_RC38
...
const EXPECTED_SOURCE_RELEASE = EXPECTED_RC38 ? 'RC38' : EXPECTED_RC37 ? 'RC37' : EXPECTED_RC36 ? 'RC36' : 'RC35';
...
const EXPECTED_SW_VERSION = EXPECTED_RC38
  ...
  : EXPECTED_RC36
    ? 'm26-rc36-canary-v10'
    : 'm26-rc35-canary-v1';
const EXPECTED_PREVIOUS_SW_VERSION = EXPECTED_RC38
  ? 'm26-rc37-iri-external-report-canary-v2'
  : EXPECTED_RC37
    ? 'm26-rc36-canary-v10'
  : EXPECTED_RC36
    ? 'm26-rc35-canary-v1'
    : 'm26-rc33-canary-v1';
const REPORT_PREFIX = EXPECTED_RC38 ? 'RC38' : EXPECTED_RC37 ? 'RC37' : EXPECTED_RC36 ? 'RC36' : 'RC35';
...
if ((EXPECTED_RC38 || EXPECTED_RC37) && runtimeConfig.iriExternalReportUploadTimeoutMs !== 180000) {

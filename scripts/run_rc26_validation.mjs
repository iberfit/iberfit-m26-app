...
const RELEASE='IBERFIT_M26_PUBLICACION_PREMIUM_RC26';
const VERSION='26.0.0-publicacion-premium.26';
const EXPECTED_TESTS=251;
...
const tasks=[
  ...
  {name:'build',command:process.execPath,args:['scripts/build_rc26_local_candidate.mjs'],timeout:60000},
  {name:'module-graph',command:process.execPath,args:['scripts/verify_rc26_module_graph.mjs'],timeout:60000},
  {name:'qa-report-verification',command:process.execPath,args:['scripts/verify_rc26_qa_reports.mjs'],timeout:60000},
  {name:'castellano-gate',command:process.execPath,args:['scripts/m26_rc26_castellano_gate.mjs'],timeout:60000},
  {name:'quality-gate',command:process.execPath,args:['scripts/m26_rc26_publication_gate.mjs'],timeout:120000},
];

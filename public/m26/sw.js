...
const APP_SHELL=['/m26/index.html','/m26/app.js','/m26/manifest.webmanifest','/m26/offline.html','/m26/offline.css','/m26/offline.js','/m26/iri-report.html','/m26/iri-report.css','/src/m26/workflows/iri-report-page.js','/m26/icons/icon-192.png','/m26/icons/icon-512.png','/m26/icons/icon-maskable-192.png','/m26/icons/icon-maskable-512.png','/m26/fonts/inter-latin-wght-normal.woff2','/m26/fonts/source-serif-4-latin-wght-normal.woff2','/src/m26/design/tokens.css','/src/m26/design/typography.css','/src/m26/design/icons.css','/src/m26/shell/shell.css','/src/m26/communication/communication.css','/src/m26/admin/admin.css','/public/isotipo-iberfit.png','/baseline_m25_2/exercise-catalog-m25.json','/public/iberfit/exercises/iberfit-exercise-media-v1.json','/public/vendor/repdb/iberfit-canonical-media-map-v1.json','/src/m26/workflows/iri-external-report.css','/src/m26/ui/client-bottom-nav.css','/src/m26/rc39/rc39.css','/src/m26/rc42/rc42.css','/src/m26/rc44/rc44.css','/src/m26/design/primitives.css','/src/m26/design/role-surfaces.css'];
...
self.addEventListener('fetch',(event)=>{
  ...
  if(CACHE_FIRST_PATHS.has(url.pathname)||/^\/public\/iberfit\/exercises\/images\/[A-Za-z0-9][A-Za-z0-9._:-]{0,199}\/(?:main|start|peak)\.webp$/.test(url.pathname)||/^\/public\/vendor\/repdb\/images\/flat\/[a-z0-9-]+-(?:main|start|peak)\.webp$/.test(url.pathname)){event.respondWith(cacheFirst(request,event));return;}

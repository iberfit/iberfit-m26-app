...
export const M26_AREAS = Object.freeze({
  ...
  actividad: Object.freeze({ key: 'actividad', label: 'Actividad', title: 'Check-ins y hábitos', scope: 'client-context', roles: ['admin', 'coach', 'client'] }),
  notas: Object.freeze({ key: 'notas', label: 'Notas privadas', title: 'Notas privadas del Coach', scope: 'selected-client', roles: ['admin', 'coach'] }),

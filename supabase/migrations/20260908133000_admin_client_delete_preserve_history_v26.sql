-- IBERFIT · ADMIN client deletion · preserve governance/history while removing client linkage.
-- Known legal/governance tables keep their rows and detach nullable client_id references.
-- Any new RESTRICT/NO ACTION client FK remains fail-closed until explicitly reviewed.
...
begin
  ...
  foreach v_table in array v_detach_history_tables loop

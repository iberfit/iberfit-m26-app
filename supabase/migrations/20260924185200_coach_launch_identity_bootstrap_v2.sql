...
'IBERFIT authenticated bootstrap; requires current privileged assurance and exposes only the current user own email, last sign-in and canonical membership status for Coach operational readiness.';

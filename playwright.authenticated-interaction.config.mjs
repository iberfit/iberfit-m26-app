...
export default defineConfig({
  ...
  use:{baseURL:'http://127.0.0.1:4197',locale:'es-ES',timezoneId:'America/Santiago',serviceWorkers:'block',trace:'retain-on-failure',screenshot:'only-on-failure',video:'off',reducedMotion:'reduce'},

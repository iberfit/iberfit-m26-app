...
const SOURCE_COPY=Object.freeze({
  ...
  'client-moment-progress-ready.title':'Ya hay evolución real que puedes revisar',
  'client-moment-progress-ready.body':'Ya existe información posterior a tu punto de partida: entrenamiento, seguimiento o actividad confirmada. Puedes abrir Progreso para ver lo que realmente ha cambiado, sin mezclar el Diagnóstico IRI inicial con tu evolución.',
  ...
  'client-feature-challenges.body':'Cuando no haya un reto activo, puedes entrar desde Más para ti en Hoy o desde Más para conocer este espacio. La participación social es opcional, privada por defecto y nunca publica datos de salud automáticamente.',
...
const TIPS=Object.freeze([
  ...
  Object.freeze({
    ...
    area:'hoy',
    actionArea:'retos',
    selectors:Object.freeze(['[data-m26-client-guide="secondary-actions"]','.m26-client-bottom-nav-more > summary']),

...
@media(max-width:900px){.m26-guided-tour{z-index:900;bottom:calc(var(--iberfit-ux-mobile-nav,4.35rem) + env(safe-area-inset-bottom) + .75rem)}}
@media(max-width:719px){.m26-guided-tour{right:.75rem;left:.75rem;width:auto;max-height:64vh;padding:var(--iberfit-space-4)}.m26-guided-tour.is-genie-led{grid-template-columns:4.35rem minmax(0,1fr);column-gap:.7rem}.m26-guided-tour-genie{width:4.35rem;height:5.55rem}.m26-guided-tour-actions{align-items:stretch}.m26-guided-tour-actions .m26-primary-action{margin-left:0}.m26-guided-tour-actions>button{flex:1 1 auto}}

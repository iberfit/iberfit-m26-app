...
function shellStyles(){
  ...
  @media(max-width:720px){.m26-workspace-actions{grid-template-columns:1fr}.m26-workspace-action{min-height:0}.m26-workspace-hero img{width:3rem;height:3rem}.m26-language-grid{grid-template-columns:1fr}}
  </style>`;
}

...
function workspaceHome(vm){
  ...
  return `<section class="m26-workspace-home" aria-label="${escapeHtml(tx(isAdmin?'workspace.admin.eyebrow':'workspace.coach.eyebrow','Centro de trabajo'))}" data-m26-workspace-role="${escapeHtml(role)}"><div class="m26-workspace-hero"><div><p class="m26-eyebrow">${escapeHtml(tx(isAdmin?'workspace.admin.eyebrow':'workspace.coach.eyebrow','IBERFIT'))}</p><h2>${escapeHtml(tx(isAdmin?'workspace.admin.title':'workspace.coach.title','IBERFIT'))}</h2><p>${escapeHtml(tx(isAdmin?'workspace.admin.copy':'workspace.coach.copy',''))}</p></div><img src="/public/isotipo-iberfit.png" alt="" aria-hidden="true"></div>${shortcuts}</section>`;
}
...
function shellStyles(){
  ...
  .m26-sidebar{overflow-y:auto;scrollbar-width:thin;display:flex;flex-direction:column}
  .m26-sidebar-navigation{min-height:0}
  ...
  .m26-topbar{position:sticky;top:0;z-index:20;min-height:4.15rem;backdrop-filter:blur(18px);background:color-mix(in srgb,#07150f 90%,transparent);border-bottom:1px solid rgba(214,182,109,.1)}
  .m26-topbar-heading{min-width:0}.m26-topbar-heading h1{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  .m26-topbar-actions{align-items:center}.m26-topbar-actions:empty{display:none}
  .m26-sidebar-footer{margin-top:auto;position:sticky;bottom:0;z-index:12;padding:.8rem .15rem .15rem;background:linear-gradient(180deg,rgba(7,21,15,0),rgba(7,21,15,.97) 20%)}
  .m26-sidebar-identity{padding:.65rem .65rem .55rem}.m26-sidebar-identity span,.m26-sidebar-identity strong{display:block}.m26-sidebar-identity span{color:rgba(214,182,109,.78);font-size:.68rem;letter-spacing:.08em;text-transform:uppercase}.m26-sidebar-identity strong{margin-top:.2rem;font-size:.84rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  .m26-settings-menu{position:relative}.m26-settings-menu>summary{list-style:none;display:flex;align-items:center;gap:.55rem}.m26-settings-menu>summary::-webkit-details-marker{display:none}.m26-language-mini{font-size:1.05rem}
  .m26-settings-popover{position:absolute;left:calc(100% + .7rem);bottom:0;width:min(28rem,calc(100vw - 19rem));max-height:min(78vh,44rem);overflow:auto;padding:1.1rem;border:1px solid rgba(214,182,109,.24);border-radius:1.1rem;background:#0c2419;box-shadow:0 24px 70px rgba(0,0,0,.42);z-index:80}.m26-settings-popover header h2{margin:.2rem 0 .3rem}.m26-settings-popover header p:last-child{margin:.25rem 0 0;color:rgba(247,241,228,.68)}
  .m26-sidebar-guide,.m26-sidebar-logout{width:100%;margin-top:.2rem;padding:.55rem .72rem;border:0;border-radius:.75rem;background:transparent;text-align:left;font:inherit}
  .m26-sidebar-guide{color:rgba(214,182,109,.82);font-size:.8rem;font-weight:720}.m26-sidebar-guide:hover,.m26-sidebar-guide:focus-visible{color:var(--m26-v2-cream);background:rgba(214,182,109,.07)}
  .m26-sidebar-logout{margin-top:.25rem;color:rgba(247,241,228,.58)}.m26-sidebar-logout:hover,.m26-sidebar-logout:focus-visible{color:var(--m26-v2-cream);background:rgba(255,255,255,.045)}
  ...
  .m26-workspace-home{display:grid;gap:1rem;margin:0 0 1.15rem}.m26-workspace-hero{position:relative;overflow:hidden;display:flex;justify-content:space-between;gap:1rem;padding:clamp(1.2rem,2vw,1.75rem);border:1px solid rgba(214,182,109,.2);border-radius:1.25rem;background:linear-gradient(135deg,rgba(214,182,109,.11),rgba(21,59,43,.7))}.m26-workspace-hero:after{content:"";position:absolute;right:-6rem;top:-7rem;width:18rem;height:18rem;border-radius:50%;background:radial-gradient(circle,rgba(214,182,109,.14),transparent 68%);pointer-events:none}.m26-workspace-hero h2{max-width:24ch;margin:.22rem 0 .45rem;font-family:Georgia,"Times New Roman",serif;font-size:clamp(1.65rem,3vw,2.35rem);font-weight:560;line-height:1.08}.m26-workspace-hero p:last-child{max-width:66ch;margin:0;color:rgba(247,241,228,.74);line-height:1.55}.m26-workspace-hero img{width:4rem;height:4rem;object-fit:contain;opacity:.88}.m26-workspace-section-title{display:flex;align-items:center;justify-content:space-between;color:rgba(247,241,228,.78);font-size:.82rem;text-transform:uppercase;letter-spacing:.09em}.m26-workspace-shortcuts{overflow:hidden;border:1px solid rgba(214,182,109,.14);border-radius:1rem;background:rgba(13,45,31,.34)}.m26-workspace-shortcuts>summary{display:flex;align-items:center;justify-content:space-between;gap:.8rem;min-height:3.4rem;padding:.72rem .9rem;list-style:none;cursor:pointer;color:rgba(247,241,228,.82);font-size:.8rem;font-weight:760;letter-spacing:.08em;text-transform:uppercase}.m26-workspace-shortcuts>summary::-webkit-details-marker{display:none}.m26-workspace-shortcuts-toggle{display:grid;place-items:center;width:2rem;height:2rem;flex:0 0 auto;border:1px solid rgba(214,182,109,.16);border-radius:999px;color:var(--m26-v2-gold);background:rgba(214,182,109,.05);font-size:1rem;transition:transform .18s ease}.m26-workspace-shortcuts[open] .m26-workspace-shortcuts-toggle{transform:rotate(45deg)}.m26-workspace-shortcuts[open]>.m26-workspace-actions{padding:.15rem .75rem .75rem}.m26-workspace-actions{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.75rem}.m26-workspace-action{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:start;gap:.75rem;text-align:left;padding:1rem;border:1px solid rgba(214,182,109,.16);border-radius:1rem;color:var(--m26-v2-cream);background:rgba(13,45,31,.52);cursor:pointer;min-height:8.5rem}.m26-workspace-action:hover:not(:disabled){border-color:rgba(214,182,109,.45);background:rgba(214,182,109,.07);transform:translateY(-1px)}.m26-workspace-action:disabled{opacity:.42;cursor:not-allowed}.m26-workspace-action-icon{display:grid;place-items:center;width:2.1rem;height:2.1rem;border-radius:.65rem;color:var(--m26-v2-gold);background:rgba(214,182,109,.1)}.m26-workspace-action span:nth-child(2){display:grid;gap:.35rem}.m26-workspace-action strong{font-size:.95rem}.m26-workspace-action small{color:rgba(247,241,228,.62);line-height:1.4}.m26-workspace-action b{color:var(--m26-v2-gold);font-size:1.1rem}
  @media(max-width:1180px){.m26-workspace-actions{grid-template-columns:repeat(2,minmax(0,1fr))}}
  @media(max-width:900px){.m26-sidebar{display:none}.m26-sidebar-footer{display:none}.m26-topbar{min-height:3.9rem}.m26-topbar-actions{max-width:66%}}
  @media(max-width:720px){.m26-workspace-actions{grid-template-columns:1fr}.m26-workspace-action{min-height:0}.m26-workspace-hero img{width:3rem;height:3rem}.m26-workspace-shortcuts>summary{min-height:3.15rem;padding:.62rem .78rem}.m26-workspace-shortcuts[open]>.m26-workspace-actions{padding:.1rem .6rem .6rem}.m26-language-grid{grid-template-columns:1fr}}@media(prefers-reduced-motion:reduce){.m26-workspace-shortcuts-toggle{transition:none}}@media print{.m26-workspace-shortcuts>summary{display:none!important}.m26-workspace-shortcuts:not([open])>.m26-workspace-actions{display:grid!important}}
  </style>`;
}

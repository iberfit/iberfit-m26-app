...
export const M26_AREAS = Object.freeze({
  ...
  retos: Object.freeze({ key: 'retos', label: 'Retos', title: 'Retos y comunidad', scope: 'client-context', roles: ['client'] }),
  ajustes: Object.freeze({ key: 'ajustes', label: 'Ajustes', title: 'Ajustes', scope: 'global', roles: ['client'] }),

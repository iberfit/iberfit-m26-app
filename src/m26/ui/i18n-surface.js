...
const ROWS=Object.freeze([
  ...
  ['La verificación anterior no respondió. Vuelve a vincular este dispositivo para crear una credencial nueva y segura, o reintenta la verificación.','The previous verification did not respond. Set up this device again to create a new secure credential, or retry verification.','La vérification précédente n’a pas répondu. Configurez à nouveau cet appareil pour créer un nouvel identifiant sécurisé, ou réessayez la vérification.','A verificação anterior não respondeu. Configure novamente este dispositivo para criar uma nova credencial segura ou tente novamente a verificação.'],

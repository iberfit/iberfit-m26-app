...
const ROWS=Object.freeze([
  ...
  ['Completa el expediente por etapas. Puedes volver atrás y el borrador se guarda automáticamente.','Complete the client record step by step. You can go back and the draft is saved automatically.','Complétez le dossier client étape par étape. Vous pouvez revenir en arrière et le brouillon est enregistré automatiquement.','Complete o registo do cliente por etapas. Pode voltar atrás e o rascunho é guardado automaticamente.'],

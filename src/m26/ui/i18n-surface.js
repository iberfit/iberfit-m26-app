...
const ROWS=Object.freeze([
  ...
  ['Contexto IRI confirmado','Confirmed IRI context','Contexte IRI confirmé','Contexto IRI confirmado'],
  ['Base para este ciclo','Basis for this cycle','Base de ce cycle','Base para este ciclo'],
  ['Evaluación confirmada:','Confirmed assessment:','Évaluation confirmée :','Avaliação confirmada:'],
  ['IBERFIT propone estos datos como punto de partida; no crea, valida ni publica un plan automáticamente.','IBERFIT proposes these data as a starting point; it does not automatically create, validate, or publish a plan.','IBERFIT propose ces données comme point de départ ; aucun plan n’est créé, validé ou publié automatiquement.','A IBERFIT propõe estes dados como ponto de partida; não cria, valida nem publica um plano automaticamente.'],
  ['Revisión del Coach obligatoria','Coach review required','Révision du Coach obligatoire','Revisão do Coach obrigatória'],
  ['Prioridades confirmadas','Confirmed priorities','Priorités confirmées','Prioridades confirmadas'],
  ['Decisión de entrenamiento','Training decision','Décision d’entraînement','Decisão de treino'],
  ['Sin implicación específica registrada.','No specific training implication recorded.','Aucune implication spécifique enregistrée.','Sem implicação específica registada.'],
  ['Frecuencia orientativa:','Suggested frequency:','Fréquence indicative :','Frequência orientativa:'],
  ['Duración del expediente:','Record session duration:','Durée prévue au dossier :','Duração prevista no registo:'],
  ['Por revisar','To review','À réviser','Por rever'],
  ['Propuesta inicial desde el IRI confirmado. Revisa y adapta antes de validar.','Initial proposal from the confirmed IRI. Review and adapt it before validating.','Proposition initiale issue de l’IRI confirmé. Révisez et adaptez-la avant validation.','Proposta inicial a partir do IRI confirmado. Reveja e adapte antes de validar.'],
  ['Historial de decisiones','Decision history','Historique des décisions','Histórico de decisões'],
  ['Qué se decidió y por qué','What was decided and why','Ce qui a été décidé et pourquoi','O que foi decidido e porquê'],
  ['Solo evaluaciones IRI confirmadas. La app muestra cambios documentados y no los interpreta automáticamente como mejor o peor.','Confirmed IRI assessments only. The app shows documented changes and does not automatically interpret them as better or worse.','Uniquement les évaluations IRI confirmées. L’application affiche les changements documentés sans les interpréter automatiquement comme meilleurs ou pires.','Apenas avaliações IRI confirmadas. A aplicação mostra mudanças documentadas sem as interpretar automaticamente como melhores ou piores.'],
  ['Sin decisiones confirmadas','No confirmed decisions','Aucune décision confirmée','Sem decisões confirmadas'],
  ['El historial aparecerá cuando se confirme una evaluación IRI con prioridades y plan.','History will appear once an IRI assessment with priorities and a plan is confirmed.','L’historique apparaîtra lorsqu’une évaluation IRI avec priorités et plan sera confirmée.','O histórico aparecerá quando uma avaliação IRI com prioridades e plano for confirmada.'],
  ['Prioridades','Priorities','Priorités','Prioridades'],
  ['Sin prioridades registradas.','No priorities recorded.','Aucune priorité enregistrée.','Sem prioridades registadas.'],
  ['Implicación para el entrenamiento:','Training implication:','Implication pour l’entraînement :','Implicação para o treino:'],
  ['Plan acordado:','Agreed plan:','Plan convenu :','Plano acordado:'],
  ['Frecuencia:','Frequency:','Fréquence :','Frequência:'],
  ['Próxima reevaluación:','Next reassessment:','Prochaine réévaluation :','Próxima reavaliação:'],
  ['Prioridades añadidas:','Priorities added:','Priorités ajoutées :','Prioridades adicionadas:'],
  ['Prioridades retiradas:','Priorities removed:','Priorités retirées :','Prioridades retiradas:'],
  ['Plan acordado actualizado','Agreed plan updated','Plan convenu mis à jour','Plano acordado atualizado'],
  ['Implicación para el entrenamiento actualizada','Training implication updated','Implication pour l’entraînement mise à jour','Implicação para o treino atualizada'],
  ['Frecuencia revisada','Frequency revised','Fréquence révisée','Frequência revista'],
  ['Próxima reevaluación revisada','Next reassessment revised','Prochaine réévaluation révisée','Próxima reavaliação revista'],
  ['Decisión IRI','IRI decision','Décision IRI','Decisão IRI'],
  ['Decisión inicial','Initial decision','Décision initiale','Decisão inicial'],
  ['Prioridades actualizadas','Priorities updated','Priorités mises à jour','Prioridades atualizadas'],
  ['Plan revisado','Plan revised','Plan révisé','Plano revisto'],
  ['Decisión mantenida','Decision maintained','Décision maintenue','Decisão mantida'],
  ['Detalle de prioridades actualizado','Priority details updated','Détails des priorités mis à jour','Detalhes das prioridades atualizados'],
  ['Prioridades estructuradas','Structured priorities','Priorités structurées','Prioridades estruturadas'],
  ['Enriquece hasta las cuatro primeras prioridades escritas arriba. Los campos vacíos permanecen vacíos: IBERFIT no inventa motivos, objetivos ni estrategias.','Enrich up to the first four priorities written above. Empty fields stay empty: IBERFIT does not invent reasons, targets or strategies.','Enrichissez jusqu’aux quatre premières priorités saisies ci-dessus. Les champs vides restent vides : IBERFIT n’invente ni motifs, ni objectifs, ni stratégies.','Enriqueça até às quatro primeiras prioridades escritas acima. Os campos vazios permanecem vazios: a IBERFIT não inventa motivos, objetivos nem estratégias.'],
  ['Dominio','Domain','Domaine','Domínio'],
  ['Estado','Status','Statut','Estado'],
  ['General','General','Général','Geral'],
  ['Composición corporal','Body composition','Composition corporelle','Composição corporal'],
  ['Movimiento y movilidad','Movement and mobility','Mouvement et mobilité','Movimento e mobilidade'],
  ['Fuerza','Strength','Force','Força'],
  ['Cardio','Cardio','Cardio','Cardio'],
  ['Recuperación / contexto','Recovery / context','Récupération / contexte','Recuperação / contexto'],
  ['Adherencia','Adherence','Adhérence','Adesão'],
  ['Otro','Other','Autre','Outro'],
  ['Activa','Active','Active','Ativa'],
  ['Mantener','Maintain','Maintenir','Manter'],
  ['Completada','Completed','Terminée','Concluída'],
  ['En pausa','Paused','En pause','Em pausa'],
  ['Motivo','Rationale','Motif','Motivo'],
  ['Objetivo medible','Measurable target','Objectif mesurable','Objetivo mensurável'],
  ['Estrategia','Strategy','Stratégie','Estratégia'],
  ['Fecha de revisión','Review date','Date de révision','Data de revisão'],
  ['Motivo:','Rationale:','Motif :','Motivo:'],
  ['Objetivo:','Target:','Objectif :','Objetivo:'],
  ['Estrategia:','Strategy:','Stratégie :','Estratégia:'],
  ['Revisión:','Review:','Révision :','Revisão:'],
  ['Prioridad 1','Priority 1','Priorité 1','Prioridade 1'],
  ['Prioridad 2','Priority 2','Priorité 2','Prioridade 2'],
  ['Prioridad 3','Priority 3','Priorité 3','Prioridade 3'],
  ['Prioridad 4','Priority 4','Priorité 4','Prioridade 4'],
  ...
  ['Evolución y seguimiento','Progress and follow-up','Évolution et suivi','Evolução e acompanhamento'],
  ['Diagnóstico y reevaluación IRI','IRI assessment and reassessment','Évaluation et réévaluation IRI','Avaliação e reavaliação IRI'],
  ['Hitos IRI comparables','Comparable IRI milestones','Jalons IRI comparables','Marcos IRI comparáveis'],
  ['Diagnóstico IRI · punto de partida','IRI Assessment · starting point','Évaluation IRI · point de départ','Avaliação IRI · ponto de partida'],
  ['vs. reevaluación IRI anterior · cambio descriptivo','vs. previous IRI reassessment · descriptive change','vs réévaluation IRI précédente · changement descriptif','vs. reavaliação IRI anterior · mudança descritiva'],
  ['El Diagnóstico IRI establece la línea base; una reevaluación comparable aporta un hito del proceso, pero el seguimiento cotidiano se presenta por separado.','The IRI Assessment establishes the baseline; a comparable reassessment adds a milestone to the journey, while ongoing follow-up is shown separately.','L’évaluation IRI établit la référence ; une réévaluation comparable constitue un jalon du parcours, tandis que le suivi continu est présenté séparément.','A Avaliação IRI estabelece a linha de base; uma reavaliação comparável acrescenta um marco ao processo, enquanto o acompanhamento contínuo é apresentado separadamente.'],
  ['Planificación vs ejecución · aún sin sesiones comparables','Planning vs execution · no comparable sessions yet','Planification vs exécution · aucune séance comparable pour le moment','Planeamento vs execução · ainda sem sessões comparáveis'],
  ['De lo planificado a lo realizado','From planning to what was actually done','Du planifié au réellement réalisé','Do planeado ao realmente realizado'],
  ['Comparación descriptiva entre la planificación publicada y la ejecución confirmada.','Descriptive comparison between the published plan and confirmed execution.','Comparaison descriptive entre la planification publiée et l’exécution confirmée.','Comparação descritiva entre o planeamento publicado e a execução confirmada.'],
  ['Evidencia descriptiva','Descriptive evidence','Données descriptives','Evidência descritiva'],
  ['Previstas / registradas / omitidas','Planned / recorded / skipped','Prévues / enregistrées / omises','Previstas / registadas / omitidas'],
  ['Sustituciones','Substitutions','Substitutions','Substituições'],
  ['Series añadidas','Added sets','Séries ajoutées','Séries adicionadas'],
  ['Ejercicios añadidos','Added exercises','Exercices ajoutés','Exercícios adicionados'],
  ['Sin sesión comparable reciente','No recent comparable session','Aucune séance comparable récente','Sem sessão comparável recente'],
  ['Se necesita una sesión publicada y una ejecución confirmada para comparar.','A published session and a confirmed execution are required for comparison.','Une séance publiée et une exécution confirmée sont nécessaires pour comparer.','É necessária uma sessão publicada e uma execução confirmada para comparar.'],
  ['Ejecuciones sin plan comparable','Executions without a comparable plan','Exécutions sans plan comparable','Execuções sem plano comparável'],
  ['Ventana actual','Current window','Fenêtre actuelle','Janela atual'],
  ['Sesiones sin ajustes explícitos','Sessions without explicit adjustments','Séances sans ajustements explicites','Sessões sem ajustes explícitos'],
  ['Sesiones con ajustes explícitos','Sessions with explicit adjustments','Séances avec ajustements explicites','Sessões com ajustes explícitos'],
  ['Sesiones comparables','Comparable sessions','Séances comparables','Sessões comparáveis'],
  ['Series previstas','Planned sets','Séries prévues','Séries previstas'],
  ['Series registradas','Recorded sets','Séries enregistrées','Séries registadas'],
  ['Series omitidas','Skipped sets','Séries omises','Séries omitidas'],
  ['Planificación publicada','Published plan','Planification publiée','Planeamento publicado'],
  ['Ejecución confirmada','Confirmed execution','Exécution confirmée','Execução confirmada'],
  ['Nunca se cuentan como registradas','Never counted as recorded','Jamais comptées comme enregistrées','Nunca são contadas como registadas'],
  ['Última sesión comparable','Latest comparable session','Dernière séance comparable','Última sessão comparável'],
  ['Ajustes registrados','Recorded adjustments','Ajustements enregistrés','Ajustes registados'],
  ['Series previstas sin resolver','Planned sets unresolved','Séries prévues non résolues','Séries previstas por resolver'],
  ['Ninguna','None','Aucune','Nenhuma'],
  ['Lectura descriptiva.','Descriptive view.','Lecture descriptive.','Leitura descritiva.'],
  ['Omitir, sustituir o añadir trabajo no se clasifica automáticamente como mejor o peor. IBERFIT conserva lo ocurrido y el Coach interpreta el contexto.','Skipping, substituting, or adding work is not automatically classified as better or worse. IBERFIT preserves what happened and the Coach interprets the context.','Omettre, remplacer ou ajouter du travail n’est pas automatiquement classé comme meilleur ou pire. IBERFIT conserve ce qui s’est produit et le Coach interprète le contexte.','Omitir, substituir ou acrescentar trabalho não é automaticamente classificado como melhor ou pior. O IBERFIT preserva o que aconteceu e o Coach interpreta o contexto.'],
  ['Hitos IRI','IRI milestones','Jalons IRI','Marcos IRI'],
  ['Sin diagnóstico','No assessment','Sans évaluation','Sem avaliação'],
  ['Diagnóstico inicial o sin reevaluación comparable','Initial assessment or no comparable reassessment','Évaluation initiale ou absence de réévaluation comparable','Avaliação inicial ou sem reavaliação comparável'],
  ['Diagnóstico y reevaluaciones se comparan por dominios','Assessment and reassessments are compared by domain','Évaluation et réévaluations sont comparées par domaine','Avaliação e reavaliações são comparadas por domínio'],
  ['Evolución del proceso','Progress over time','Évolution du parcours','Evolução do processo'],
  ['Diagnóstico IRI inicial confirmado: este es el punto de partida del proceso.','Initial IRI assessment confirmed: this is the starting point of the process.','Évaluation IRI initiale confirmée : c’est le point de départ du parcours.','Avaliação IRI inicial confirmada: este é o ponto de partida do processo.'],
  ['El Diagnóstico IRI establece el punto de partida; las reevaluaciones IRI son hitos comparables dentro del seguimiento continuo.','The IRI Assessment establishes the starting point; IRI reassessments are comparable milestones within ongoing follow-up.','L’évaluation IRI établit le point de départ ; les réévaluations IRI sont des jalons comparables dans le suivi continu.','A Avaliação IRI estabelece o ponto de partida; as reavaliações IRI são marcos comparáveis no acompanhamento contínuo.'],
  ['vs. reevaluación anterior · cambio descriptivo','vs. previous reassessment · descriptive change','vs réévaluation précédente · changement descriptif','vs. reavaliação anterior · mudança descritiva'],
  ['Sin puntuación global','No global score','Sans score global','Sem pontuação global'],
  ['Solo se muestran cambios entre evaluaciones confirmadas y mediciones metodológicamente comparables.','Only changes between confirmed assessments and methodologically comparable measurements are shown.','Seuls les changements entre évaluations confirmées et mesures méthodologiquement comparables sont affichés.','Mostram-se apenas mudanças entre avaliações confirmadas e medições metodologicamente comparáveis.'],
  ['Primera evaluación confirmada: se establece la línea base.','First confirmed assessment: the baseline is established.','Première évaluation confirmée : la ligne de base est établie.','Primeira avaliação confirmada: estabelece-se a linha de base.'],
  ['Sin cambio comparable','No comparable change','Aucun changement comparable','Sem mudança comparável'],
  ['vs. evaluación anterior · cambio descriptivo','vs. previous assessment · descriptive change','vs évaluation précédente · changement descriptif','vs. avaliação anterior · mudança descritiva'],
  ['Línea base IRI','IRI baseline','Ligne de base IRI','Linha de base IRI'],
  ['indicadores comparables','comparable indicators','indicateurs comparables','indicadores comparáveis'],
  ['Comparación con','Comparison with','Comparaison avec','Comparação com'],
  ...
  ['La ficha cambió mientras la estabas editando. La vista se actualizará para que revises la última versión antes de guardar de nuevo.','The client record changed while you were editing it. The view will refresh so you can review the latest version before saving again.','Le dossier client a changé pendant votre modification. La vue va se mettre à jour afin que vous puissiez vérifier la dernière version avant de l’enregistrer à nouveau.','O registo do cliente mudou enquanto estava a editá-lo. A vista será atualizada para rever a versão mais recente antes de guardar novamente.'],
  ['Revisa los datos obligatorios de la ficha antes de guardar.','Review the required client record fields before saving.','Vérifiez les champs obligatoires du dossier client avant d’enregistrer.','Reveja os campos obrigatórios do registo do cliente antes de guardar.'],
  ['No fue posible abrir la ficha del cliente.','The client record could not be opened.','Impossible d’ouvrir le dossier client.','Não foi possível abrir o registo do cliente.'],
  ['Coach responsable','Responsible Coach','Coach responsable','Coach responsável'],
  ['Asignar después','Assign later','Attribuer plus tard','Atribuir depois'],
  ['IBERFIT creará el expediente, vinculará al Coach responsable si has seleccionado uno, conservará estos datos en el perfil del cliente y preparará su invitación segura de acceso.','IBERFIT will create the client record, link the responsible Coach if one is selected, keep these details in the client profile, and prepare a secure access invitation.','IBERFIT créera le dossier client, associera le Coach responsable si vous en avez sélectionné un, conservera ces données dans le profil du client et préparera son invitation d’accès sécurisée.','O IBERFIT criará o registo do cliente, associará o Coach responsável se tiver selecionado um, guardará estes dados no perfil do cliente e preparará o convite de acesso seguro.'],
  ['Prospección','Prospecting','Prospection','Prospecção'],
  ['Registrar un lead','Register a lead','Enregistrer un prospect','Registar um lead'],
  ['Registrar lead','Register lead','Enregistrer le prospect','Registar lead'],
  ['Guardar lead','Save lead','Enregistrer le prospect','Guardar lead'],
  ['Contacto comercial','Sales contact','Contact commercial','Contacto comercial'],
  ['Registra un contacto potencial sin crear todavía un expediente ni conceder acceso.','Register a potential contact without creating a client record or granting access yet.','Enregistrez un contact potentiel sans créer encore de dossier client ni accorder d’accès.','Registe um contacto potencial sem criar ainda um registo de cliente nem conceder acesso.'],
  ['Úsalo solo para contactos potenciales. Cuando la persona pase a ser cliente, utiliza “Nuevo cliente” para crear su expediente real y enviar el acceso.','Use this only for potential contacts. When the person becomes a client, use “New client” to create the real client record and send access.','Utilisez ceci uniquement pour les contacts potentiels. Lorsque la personne devient cliente, utilisez « Nouveau client » pour créer son dossier réel et envoyer l’accès.','Use apenas para contactos potenciais. Quando a pessoa passar a cliente, utilize “Novo cliente” para criar o registo real e enviar o acesso.'],
  ['1 · Registrar contacto','1 · Register contact','1 · Enregistrer le contact','1 · Registar contacto'],
  ['2 · Cualificar','2 · Qualify','2 · Qualifier','2 · Qualificar'],
  ['3 · Convertir en cliente','3 · Convert to client','3 · Convertir en client','3 · Converter em cliente'],
  ['Lead en curso','Lead in progress','Prospect en cours','Lead em curso'],
  ...
  ['Revisión','Review','Révision','Revisão'],
  ['1 · Datos personales y contacto','1 · Personal details and contact','1 · Données personnelles et contact','1 · Dados pessoais e contacto'],
  ['Completar después','Complete later','Compléter plus tard','Completar depois'],
  ['2 · Servicio y logística','2 · Service and logistics','2 · Service et logistique','2 · Serviço e logística'],
  ['Duración por sesión','Session duration','Durée par séance','Duração por sessão'],
  ['Diagnóstico inicial','Initial assessment','Évaluation initiale','Avaliação inicial'],
  ['Realizar Diagnóstico IRI','Perform IRI Assessment','Réaliser l’évaluation IRI','Realizar Avaliação IRI'],
  ['Teléfono de emergencia','Emergency phone','Téléphone d’urgence','Telefone de emergência'],
  ['Revisar alta','Review client setup','Vérifier la création','Rever criação'],
  ['5 · Revisión antes de crear','5 · Review before creating','5 · Vérification avant création','5 · Revisão antes de criar'],
  ['Editar datos','Edit details','Modifier les données','Editar dados'],
  ['Qué ocurrirá al confirmar','What happens when you confirm','Ce qui se passera après confirmation','O que acontecerá ao confirmar'],
  ['IBERFIT creará el expediente, conservará estos datos en el perfil del cliente y preparará su invitación segura de acceso.','IBERFIT will create the client record, keep these details in the client profile, and prepare a secure access invitation.','IBERFIT créera le dossier client, conservera ces données dans son profil et préparera son invitation d’accès sécurisée.','O IBERFIT criará o registo do cliente, guardará estes dados no perfil e preparará o convite de acesso seguro.'],
  ['cliente@correo.com','client@email.com','client@e-mail.fr','cliente@email.com'],
  ['Ej. tardes, después de las 18:00','E.g. evenings, after 6:00 pm','Ex. le soir, après 18 h','Ex. tardes, depois das 18:00'],
  ['Dirección o lugar habitual','Address or usual location','Adresse ou lieu habituel','Morada ou local habitual'],
  ['Conserjería, estacionamiento, acceso, etc.','Reception, parking, access, etc.','Accueil, stationnement, accès, etc.','Portaria, estacionamento, acesso, etc.'],
  ['Qué quiere conseguir y por qué es importante','What they want to achieve and why it matters','Ce que la personne souhaite atteindre et pourquoi cela compte','O que pretende alcançar e por que é importante'],
  ['Separados por coma o una línea por objetivo','Separate with commas or one goal per line','Séparez par des virgules ou un objectif par ligne','Separados por vírgulas ou um objetivo por linha'],
  ['Qué está haciendo actualmente','What they are currently doing','Ce que la personne fait actuellement','O que está a fazer atualmente'],
  ['Limitaciones o indicaciones relevantes para el entrenamiento','Relevant limitations or guidance for training','Limitations ou consignes pertinentes pour l’entraînement','Limitações ou orientações relevantes para o treino'],
  ['Localización, situación y aquello que deba conocer el Coach','Location, situation, and anything the Coach should know','Localisation, situation et informations utiles au Coach','Localização, situação e o que o Coach deve saber'],
  ['Preferencias, ejercicios que disfruta, contexto útil para adherencia','Preferences, exercises they enjoy, and context that may support adherence','Préférences, exercices appréciés et contexte utile pour l’adhésion','Preferências, exercícios de que gosta e contexto útil para a adesão'],
  ...
  ['Verificación segura confirmada. Cargando IBERFIT…','Secure verification confirmed. Loading IBERFIT…','Vérification sécurisée confirmée. Chargement d’IBERFIT…','Verificação segura confirmada. A carregar o IBERFIT…'],
  ['Acceso verificado','Access verified','Accès vérifié','Acesso verificado'],
  ['Entrando en IBERFIT','Entering IBERFIT','Entrée dans IBERFIT','A entrar no IBERFIT'],
  ['La identidad ya está confirmada. Estamos cargando tu entorno seguro.','Your identity is already confirmed. We are loading your secure workspace.','Votre identité est déjà confirmée. Nous chargeons votre espace sécurisé.','A sua identidade já está confirmada. Estamos a carregar o seu espaço seguro.'],
  ['Cargando tu espacio…','Loading your workspace…','Chargement de votre espace…','A carregar o seu espaço…'],
  ['Si la carga segura tarda demasiado, IBERFIT liberará esta pantalla para que puedas reintentar sin repetir la contraseña.','If secure loading takes too long, IBERFIT will release this screen so you can retry without entering your password again.','Si le chargement sécurisé prend trop de temps, IBERFIT libérera cet écran afin que vous puissiez réessayer sans saisir à nouveau votre mot de passe.','Se o carregamento seguro demorar demasiado, o IBERFIT libertará este ecrã para que possa tentar novamente sem introduzir a palavra-passe outra vez.'],
  ...
  ['La ejecución ya está registrada. Completa el cierre con el feedback del cliente.','The session execution is already recorded. Complete the closeout with the client\'s feedback.','L’exécution de la séance est déjà enregistrée. Terminez la clôture avec le feedback du client.','A execução da sessão já está registada. Conclua o encerramento com o feedback do cliente.'],
  ['Registra el feedback del cliente','Record the client\'s feedback','Enregistrez le feedback du client','Registe o feedback do cliente'],
  ['RPE del cliente','Client RPE','RPE du client','RPE do cliente'],
  ['Feedback / percepción del cliente','Client feedback / perception','Feedback / perception du client','Feedback / perceção do cliente'],
  ['Este feedback forma parte del registro del cliente. Para observaciones internas utiliza Notas privadas del entrenador.','This feedback is part of the client record. Use the Coach private notes for internal observations.','Ce feedback fait partie du dossier du client. Utilisez les notes privées du Coach pour les observations internes.','Este feedback faz parte do registo do cliente. Utilize as notas privadas do Coach para observações internas.'],
  ...
  ['Contexto profesional previo a la sesión','Professional pre-session context','Contexte professionnel avant la séance','Contexto profissional pré-sessão'],
  ['Cierre confirmado','Confirmed closeout','Clôture confirmée','Encerramento confirmado'],
  ['Sin cierre confirmado','No confirmed closeout','Aucune clôture confirmée','Sem encerramento confirmado'],
  ['Sin comentario final confirmado.','No confirmed final feedback.','Aucun feedback final confirmé.','Sem feedback final confirmado.'],
  ['No hay una ejecución confirmada anterior para contextualizar esta sesión.','There is no previous confirmed execution to contextualize this session.','Aucune exécution confirmée antérieure n’est disponible pour contextualiser cette séance.','Não existe uma execução confirmada anterior para contextualizar esta sessão.'],
  ['Último cierre confirmado','Latest confirmed closeout','Dernière clôture confirmée','Último encerramento confirmado'],
  ['Decisiones del Coach','Coach decisions','Décisions du Coach','Decisões do Coach'],
  ['Sin decisiones abiertas','No open decisions','Aucune décision ouverte','Sem decisões abertas'],
  ['No hay seguimientos profesionales pendientes antes de iniciar.','There are no pending professional follow-ups before starting.','Aucun suivi professionnel n’est en attente avant de commencer.','Não há acompanhamentos profissionais pendentes antes de iniciar.'],
  ['Dolor o molestia registrado','Pain or discomfort recorded','Douleur ou gêne enregistrée','Dor ou desconforto registado'],

...
const ROWS=Object.freeze([
  ...
  ['Este feedback forma parte del registro del cliente. Para observaciones internas utiliza Nota privada en el expediente.','This feedback is part of the client record. Use Private note in the client record for internal observations.','Ce feedback fait partie du dossier du client. Utilisez Note privée dans le dossier pour les observations internes.','Este feedback faz parte do registo do cliente. Utilize Nota privada no processo para observações internas.'],

...
const ROWS=Object.freeze([
  ...
  ['revisar','review','réviser','rever'],
  ['evolución','progress','évolution','evolução'],
  ['sin comparación','no comparison','aucune comparaison','sem comparação'],
  ['Resumen de evolución por ejercicio','Exercise progress summary','Résumé de la progression par exercice','Resumo da evolução por exercício'],
  ...
  ['Contexto profesional activo','Active professional context','Contexte professionnel actif','Contexto profissional ativo'],
  ['Mantener presente','Keep in mind','À garder à l’esprit','Manter presente'],
  ['Dolor o molestia en el último cierre','Pain or discomfort in the latest closeout','Douleur ou gêne lors de la dernière clôture','Dor ou desconforto no último encerramento'],
  ['Dato confirmado del último cierre; mantén este contexto presente durante la sesión.','Confirmed data from the latest closeout; keep this context in mind during the session.','Donnée confirmée de la dernière clôture ; gardez ce contexte à l’esprit pendant la séance.','Dado confirmado do último encerramento; mantenha este contexto presente durante a sessão.'],
  ['Decisión vencida','Overdue decision','Décision en retard','Decisão vencida'],
  ['Existe una decisión profesional pendiente de revisión.','There is a professional decision pending review.','Une décision professionnelle est en attente de révision.','Existe uma decisão profissional pendente de revisão.'],
  ['Decisión para revisar hoy','Decision to review today','Décision à réviser aujourd’hui','Decisão para rever hoje'],
  ['Existe una decisión profesional prevista para revisión hoy.','There is a professional decision scheduled for review today.','Une décision professionnelle est prévue pour révision aujourd’hui.','Existe uma decisão profissional prevista para revisão hoje.'],

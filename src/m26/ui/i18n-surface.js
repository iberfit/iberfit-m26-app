...
const ROWS=Object.freeze([
  ...
  ['Señales comparables por ejercicio','Comparable exercise signals','Signaux comparables par exercice','Sinais comparáveis por exercício'],
  ['Ejercicios que merecen una mirada','Exercises worth reviewing','Exercices à examiner','Exercícios que merecem revisão'],
  ['Solo cambios confirmados con una métrica comparable que sustenta la clasificación. No atribuye causalidad.','Only confirmed changes with a comparable metric supporting the classification are shown. This does not imply causality.','Seuls les changements confirmés disposant d’une métrique comparable soutenant la classification sont affichés. Cela n’implique pas de causalité.','São mostradas apenas alterações confirmadas com uma métrica comparável que sustenta a classificação. Isto não implica causalidade.'],
  ['Carga comparable','Comparable load','Charge comparable','Carga comparável'],
  ['Repeticiones por serie','Repetitions per set','Répétitions par série','Repetições por série'],
  ['Segundos por serie','Seconds per set','Secondes par série','Segundos por série'],
  ['RPE medio','Average RPE','RPE moyen','RPE médio'],
  ['RIR medio','Average RIR','RIR moyen','RIR médio'],
  ...
  ['Retroceso','Regression','Régression','Regressão'],
  ['Estable','Stable','Stable','Estável'],

...
const BUNDLES=Object.freeze({
  es:Object.freeze({
    ...
    'settings.securityDevice':'Dispositivos de confianza',
    'settings.securityDeviceCopy':'Añade otra passkey desde esta sesión ya verificada para no depender de un único dispositivo.',
    'settings.addTrustedDevice':'Añadir dispositivo seguro',
    'settings.addTrustedDeviceHint':'IBERFIT volverá a pedir la seguridad nativa del dispositivo. No recibe tu PIN, contraseña ni biometría.',
  ...
  fr:Object.freeze({
    ...
    'settings.title':'Réglages','settings.open':'Réglages','settings.subtitle':'Personnalisez votre expérience IBERFIT','settings.language':'Langue de l’application','settings.languageCopy':'Choisissez la langue des menus, de la navigation et des espaces de travail.','settings.region':'Région et formats','settings.regionCopy':'Adaptez les formats régionaux sans changer de langue.','settings.savedLocal':'Votre préférence est enregistrée sur cet appareil.','settings.fullSettings':'Ouvrir tous les réglages','settings.privacy':'Confidentialité','settings.securityDevice':'Appareils de confiance','settings.securityDeviceCopy':'Ajoutez une autre passkey depuis cette session déjà vérifiée afin de ne pas dépendre d’un seul appareil.','settings.addTrustedDevice':'Ajouter un appareil sécurisé','settings.addTrustedDeviceHint':'IBERFIT redemandera la sécurité native de cet appareil. Votre code PIN, mot de passe ou biométrie ne sont jamais transmis.',

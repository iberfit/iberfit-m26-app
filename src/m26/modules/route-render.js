...
export function renderLibraryRoute(vm){
  ...
  const creation=canCreate?`<section class="m26-panel m26-panel-soft" data-exercise-create-panel><div class="m26-panel-heading"><div><p class="m26-eyebrow">CatÃ¡logo IBERFIT</p><h2>Crear ejercicio personalizado</h2><p>AÃ±Ã¡delo una sola vez al catÃ¡logo canÃ³nico. QuedarÃ¡ disponible inmediatamente para planificar sesiones y pendiente de revisiÃ³n profesional.</p></div>${badge('Coach Â· Admin','neutral')}</div><form data-exercise-create-form><div class="m26-field-grid"><label>Nombre del ejercicio<input name="nameEs" required minlength="2" maxlength="160" autocomplete="off" spellcheck="false"></label><label>PatrÃ³n<select name="pattern" required><option value="">Selecciona</option><option value="sentadilla">Sentadilla</option><option value="bisagra">Bisagra</option><option value="empuje horizontal">Empuje horizontal</option><option value="empuje vertical">Empuje vertical</option><option value="tracciÃ³n horizontal">TracciÃ³n horizontal</option><option value="tracciÃ³n vertical">TracciÃ³n vertical</option><option value="core">Core</option><option value="movilidad">Movilidad</option><option value="potencia">Potencia</option><option value="complementario">Complementario</option></select></label><label>Objetivo<select name="intent" required><option value="">Selecciona</option><option value="fuerza">Fuerza</option><option value="hipertrofia">Hipertrofia</option><option value="tÃ©cnica">TÃ©cnica</option><option value="movilidad">Movilidad</option><option value="potencia">Potencia</option><option value="acondicionamiento">Acondicionamiento</option></select></label><label>Material<input name="equipment" required minlength="2" maxlength="80" placeholder="Ej. mancuerna, TRX, sin material"></label><label>Dificultad<select name="difficulty" required><option value="">Selecciona</option><option value="inicial">Inicial</option><option value="media">Media</option><option value="avanzada">Avanzada</option></select></label><label>Musculatura principal<input name="primaryMuscles" maxlength="960" placeholder="Ej. glÃºteos, cuÃ¡driceps"></label></div><details><summary>Completar indicaciones tÃ©cnicas</summary><div class="m26-field-grid"><label>Musculatura secundaria<input name="secondaryMuscles" maxlength="960" placeholder="Separada por comas"></label><label>Claves tÃ©cnicas<textarea name="cues" maxlength="2880" rows="3" placeholder="Una por lÃ­nea o separadas por comas"></textarea></label><label>EjecuciÃ³n<textarea name="instructionsEs" maxlength="4800" rows="4" placeholder="Pasos de ejecuciÃ³n"></textarea></label><label>Precauciones<textarea name="precautions" maxlength="2880" rows="3" placeholder="Solo cuando corresponda"></textarea></label></div></details><div class="m26-notice"><strong>CatÃ¡logo, no texto libre</strong><p>El ejercicio se crea con un ID estable IBERFIT, sin imagen hasta su validaciÃ³n. Las sesiones siguen aceptando Ãºnicamente ejercicios presentes en el catÃ¡logo.</p></div><button type="submit" class="m26-primary-action">Crear y aÃ±adir al catÃ¡logo</button><p data-exercise-create-status role="status" aria-live="polite"></p></form></section>`:'';
  return `<div class="m26-route"><section class="m26-route-intro"><div><p class="m26-eyebrow">Biblioteca visual</p><h2>Ejercicios IBERFIT</h2><p>Organizados por musculatura principal, con indicaciones y referencias visuales validadas. El catÃ¡logo sigue siendo la fuente canÃ³nica y no admite escritura libre en las sesiones.</p></div>${badge(`${vm.total} ejercicios`,'neutral')}</section>${creation}<section class="m26-panel"><div class="m26-library-controls"><label>Buscar ejercicio<input type="search" data-library-search autocomplete="off" spellcheck="false" aria-describedby="m26-library-status"></label><label>Material<select data-library-filter="equipment"><option value="">Todo</option><option value="sin material">Sin material</option><option value="trx">TRX</option><option value="mancuerna">Mancuernas</option><option value="banda">Bandas</option><option value="mÃ¡quina">MÃ¡quina</option></select></label><label>PatrÃ³n<select data-library-filter="pattern"><option value="">Todos</option><option value="sentadilla">Sentadilla</option><option value="empuje">Empuje</option><option value="tracciÃ³n">TracciÃ³n</option><option value="bisagra">Bisagra</option><option value="core">Core</option></select></label><label>Referencia visual<select data-library-filter="visual"><option value="">Todas</option><option value="with-image">Con imagen validada</option><option value="without-image">Sin imagen</option></select></label><button type="button" data-library-clear>Limpiar filtros</button></div><div class="m26-library-groups" data-library-grid>${groups||emptyState('Biblioteca no cargada','No se pudo leer el catÃ¡logo local.')}</div><p id="m26-library-status" data-library-status role="status" aria-live="polite">Mostrando los ${vm.total} ejercicios del catÃ¡logo, agrupados por musculatura principal. Escribe para filtrar.</p>${credit}</section></div>`;
}

...
function renderCoachHoyRoute(vm) {
  ...
  const primaryAction=primary.clientId
    ?`<button type="button" class="m26-primary-action" data-m26-coach-action="true" data-m26-select-client="${escapeHtml(primary.clientId)}" data-m26-client-id="${escapeHtml(primary.clientId)}" data-m26-target-area="${escapeHtml(primary.area)}">${escapeHtml(primary.label)}</button>`

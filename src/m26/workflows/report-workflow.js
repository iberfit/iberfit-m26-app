...
export const PREMIUM_REPORT_MODEL_VERSION='iberfit-premium-report-lineage-v1';
export const PREMIUM_REPORT_TYPES=Object.freeze([
  ...
  Object.freeze({id:'reassessment',label:'Informe de reevaluación IRI',cadence:'reevaluación'}),

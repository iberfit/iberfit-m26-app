...
export function normalizeBootstrapRole(bootstrap={}){return normalizeRegistryRole(bootstrap.user?.role||bootstrap.role||bootstrap.profile?.role||bootstrap.user_profile?.role||bootstrap.data?.user?.role||'');}

...
test('surface translator covers representative Admin Coach Client and access/session UI',()=>{
  const cases=[
    ...
    ['El entrenamiento cambió después de escribir este feedback. Revísalo antes de finalizar para confirmar que sigue representando la sesión completa.','The workout changed after this feedback was written. Review it before finishing to confirm it still reflects the full session.','L’entraînement a changé après la saisie de ce feedback. Vérifiez-le avant de terminer afin de confirmer qu’il reflète toujours l’ensemble de la séance.','O treino mudou depois de este feedback ter sido escrito. Reveja-o antes de terminar para confirmar que continua a representar a sessão completa.'],

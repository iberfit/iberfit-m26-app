...
import {createWebPushCoordinator} from '../src/m26/communication/web-push.js';
...
test('disable current device revokes the exact endpoint before removing the local subscription',async()=>{
  const existing={endpoint:serialized.endpoint,getKey:(name)=>new Uint8Array(name==='p256dh'?[1,2,3]:[4,5,6]).buffer};
